...
OBJ    = main.o DrawCircle.o ProjectiveCamera.o CameraCalibrationZhang.o ObjLoader.o
RM     = rm -f
BIN    = arTeapot
...
main.o : main.cpp ObjLoader.o ProjectiveCamera.o CameraCalibrationZhang.o 
	@echo "compile main"
	$(CC) $(CFLAGS) $(INCLUDES) -c $<  
	@echo "done..."
